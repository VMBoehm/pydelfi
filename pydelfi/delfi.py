...
class Delfi():
    ...
    def __init__(self, data, prior, nde, \
                 ...
                 graph_restore_filename = "graph_checkpoint", restore_filename = "restore.pkl", restore = False, save = True, opt_args={}):
        ...
        self.n_ndes = len(nde)
        self.nde = nde
        self.trainer = [pydelfi.train.ConditionalTrainer(nde[i],optimizer_arguments=opt_args) for i in range(self.n_ndes)]
